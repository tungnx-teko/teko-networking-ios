...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tungnx-teko/Networking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tungnx-teko' => 'tung.nx@teko.vn' }
  s.source           = { :git => 'https://github.com/tungnx-teko/Networking.git', :tag => s.version.to_s }
  ...
  s.resources = 'Networking/Sources/**/*.{xcassets,json,storyboard,xib,xcdatamodeld}'
